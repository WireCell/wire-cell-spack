...
class Paal(Package):
    """
    A header-only, generic library consisting of approximation algorithms,
    data structures and several complete solutions for the various optimization
    problems.

    Note, PAAL has suffered bitrot over the ages, particularly due to depending
    on "boost" code that never went into boost such as "numeric bindings".
    Maybe that refers to these:
    ...
    version("2017-01-30",
            sha256sum="83487de59e8f7ded1a488ad8ad5359c358fb45a59e548d499f6dc44d712c82ad",
