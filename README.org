...
This installed the toolkit right into the view directory.  That's okay.  You can also point =--prefix= to some other location but then you will also need to add to your =PATH=-like to run the code.
